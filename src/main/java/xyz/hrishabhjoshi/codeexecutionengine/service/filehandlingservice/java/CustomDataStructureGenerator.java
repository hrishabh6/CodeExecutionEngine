...
public class CustomDataStructureGenerator {
        ...
        public static String generateCustomStructureHelper(String structureName) {
                ...
                switch (structureName) {
                        case "ListNode":
                                // Single ListNode builder
                                helper.append(
                                                "    private static ListNode buildListNode(String jsonString, boolean isListType) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                ...
                                helper.append("        }\n");
                                helper.append(
                                                "        List<Integer> list = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class));\n");
                                ...
                                // List<ListNode> builder
                                helper.append(
                                                "    private static List<ListNode> buildListNodeList(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                                helper.append("            return new ArrayList<>();\n");
                                helper.append("        }\n");
                                helper.append(
                                                "        List<List<Integer>> listOfLists = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class)));\n");
                                ...
                                // ListNode[] array builder
                                helper.append(
                                                "    private static ListNode[] buildListNodeArray(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                        ...
                        case "TreeNode":
                                // Single TreeNode builder
                                helper.append(
                                                "    private static TreeNode buildTreeNode(String jsonString, boolean isListType) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append(
                                                "        List<Integer> list = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class));\n");
                                ...
                                // List<TreeNode> builder
                                helper.append(
                                                "    private static List<TreeNode> buildTreeNodeList(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                                helper.append("            return new ArrayList<>();\n");
                                helper.append("        }\n");
                                helper.append(
                                                "        List<List<Integer>> listOfLists = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class)));\n");
                                helper.append("        List<TreeNode> result = new ArrayList<>();\n");
                                helper.append("        for (List<Integer> treeValues : listOfLists) {\n");
                                helper.append(
                                                "            if (treeValues == null || treeValues.isEmpty() || (treeValues.size() == 1 && treeValues.get(0) == null)) {\n");
                                helper.append("                result.add(null);\n");
                                helper.append("            } else {\n");
                                helper.append("                Queue<TreeNode> queue = new LinkedList<>();\n");
                                ...
                                helper.append("                queue.offer(root);\n");
                                helper.append("                int i = 1;\n");
                                helper.append("                while (!queue.isEmpty() && i < treeValues.size()) {\n");
                                helper.append("                    TreeNode current = queue.poll();\n");
                                helper.append("                    if (i < treeValues.size() && treeValues.get(i) != null) {\n");
                                helper.append("                        current.left = new TreeNode(treeValues.get(i));\n");
                                helper.append("                        queue.offer(current.left);\n");
                                helper.append("                    }\n");
                                helper.append("                    i++;\n");
                                helper.append("                    if (i < treeValues.size() && treeValues.get(i) != null) {\n");
                                helper.append("                        current.right = new TreeNode(treeValues.get(i));\n");
                                helper.append("                        queue.offer(current.right);\n");
                                helper.append("                    }\n");
                                helper.append("                    i++;\n");
                                helper.append("                }\n");
                                helper.append("                result.add(root);\n");
                                helper.append("            }\n");
                                helper.append("        }\n");
                                helper.append("        return result;\n");
                                helper.append("    }\n\n");

                                // TreeNode[] array builder
                                helper.append(
                                                "    private static TreeNode[] buildTreeNodeArray(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                        ...
                        case "Node":
                                // Single Node builder
                                helper.append(
                                                "    private static Node buildNode(String jsonString, boolean isListType) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append(
                                                "        List<List<Integer>> adjList = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class)));\n");
                                ...
                                // List<Node> builder
                                helper.append(
                                                "    private static List<Node> buildNodeList(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                                helper.append("            return new ArrayList<>();\n");
                                helper.append("        }\n");
                                helper.append(
                                                "        List<List<List<Integer>>> listOfGraphs = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, mapper.getTypeFactory().constructCollectionType(List.class, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class))));\n");
                                helper.append("        List<Node> result = new ArrayList<>();\n");
                                helper.append("        for (List<List<Integer>> adjList : listOfGraphs) {\n");
                                helper.append("            if (adjList == null || adjList.isEmpty()) {\n");
                                helper.append("                result.add(null);\n");
                                helper.append("            } else {\n");
                                helper.append("                Map<Integer, Node> nodes = new HashMap<>();\n");
                                ...
                                helper.append("                    }\n");
                                helper.append("                }\n");
                                helper.append("                result.add(nodes.get(1));\n");
                                helper.append("            }\n");
                                helper.append("        }\n");
                                helper.append("        return result;\n");
                                helper.append("    }\n\n");
                                ...
                                // Node[] array builder
                                helper.append(
                                                "    private static Node[] buildNodeArray(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                                ...
                                // Keep the existing output helper method for Node serialization
                                helper.append(
                                                "    private static String convertNodeToJson(Node node) throws JsonProcessingException {\n");
                                helper.append("        if (node == null) {\n");
                                helper.append("            return \"[]\";  // Empty graph = empty array per LeetCode format\n");
                                helper.append("        }\n");
                                ...
                                helper.append("                if (adjList.size() > n.val - 1) {\n");
        ...
        public static String generateListConverterMethods(String structureName) {
                ...
                switch (structureName) {
                        case "ListNode":
                                converters.append(
                                                "    private static String convertListNodeListToJson(List<ListNode> list) throws JsonProcessingException {\n");
                                ...
                                converters.append(
                                                "    private static String convertListNodeToJson(ListNode node) throws JsonProcessingException {\n");
                                converters.append("        if (node == null) {\n");
                                converters
                                                .append("            return \"[]\";  // Empty linked list = empty array per LeetCode format\n");
                                converters.append("        }\n");
                        ...
                        case "TreeNode":
                                converters.append(
                                                "    private static String convertTreeNodeListToJson(List<TreeNode> list) throws JsonProcessingException {\n");
                                converters.append("        if (list == null) {\n");
                                converters.append("            return \"null\";\n");
                                converters.append("        }\n");
                                converters.append("        List<List<Integer>> result = new ArrayList<>();\n");
                                ...
                                converters.append(
                                                "                while (!treeList.isEmpty() && treeList.get(treeList.size() - 1) == null) {\n");
                                ...
                                converters.append(
                                                "    private static String convertTreeNodeToJson(TreeNode root) throws JsonProcessingException {\n");
                                converters.append("        if (root == null) {\n");
                                converters.append(
                                                "            return \"[]\";  // Empty tree = empty array per LeetCode format\n");
                                converters.append("        }\n");
                                converters.append("        List<Integer> result = new ArrayList<>();\n");
                                converters.append("        Queue<TreeNode> queue = new LinkedList<>();\n");
                                converters.append("        queue.offer(root);\n");
                        ...
                        case "Node":
                                ...
                                // Node list converter
                                converters.append(
                                                "    private static String convertNodeListToJson(List<Node> list) throws JsonProcessingException {\n");
                                converters.append("        if (list == null) {\n");
                                converters.append("            return \"null\";\n");
                                converters.append("        }\n");
                                ...
                                converters.append("            } else {\n");
                                converters.append(
                                                "                String adjListJson = convertNodeToJson(node);\n");
                                converters.append("                ObjectMapper mapper = new ObjectMapper();\n");
                                converters.append(
                                                "                List<List<Integer>> adjList = mapper.readValue(adjListJson, mapper.getTypeFactory().constructCollectionType(List.class, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class)));\n");
