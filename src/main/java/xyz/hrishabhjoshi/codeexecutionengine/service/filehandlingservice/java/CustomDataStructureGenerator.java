    ...
    public static String generateCustomStructureHelper(String structureName) {
        ...
        switch (structureName) {
            ...
            case "TreeNode":
                ...
                helper.append("    private static TreeNode buildTreeNode(String jsonString, boolean isListType) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                helper.append("        List<Integer> list = mapper.readValue(jsonString, mapper.getTypeFactory().constructCollectionType(List.class, Integer.class));\n");
                ...
                helper.append("    private static List<TreeNode> buildTreeNodeList(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                helper.append("            return new ArrayList<>();\n");
                helper.append("        }\n");
                ...
                helper.append("            if (treeValues == null || treeValues.isEmpty() || (treeValues.size() == 1 && treeValues.get(0) == null)) {\n");
                helper.append("                result.add(null);\n");
                helper.append("            } else {\n");
                helper.append("                Queue<TreeNode> queue = new LinkedList<>();\n");
            ...
            case "Node":
                // Single Node builder
                helper.append("    private static Node buildNode(String jsonString, boolean isListType) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                ...
                // List<Node> builder
                helper.append("    private static List<Node> buildNodeList(String jsonString) throws com.fasterxml.jackson.core.JsonProcessingException {\n");
                helper.append("        ObjectMapper mapper = new ObjectMapper();\n");
                helper.append("        if (jsonString.equals(\"[]\")) {\n");
                helper.append("            return new ArrayList<>();\n");
                helper.append("        }\n");
